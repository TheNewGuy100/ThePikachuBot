...
export async function loop(client, message, args) {
    ...
    if (!client.player.getQueue(message)) return message.channel.send(`${client.emotes.error} - Nenhuma música atualmente tocando !`);

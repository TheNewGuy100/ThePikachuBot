...
exports.clearFila = void 0;
function clearFila(client, message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (client.player.getQueue(message).tracks.length <= 1)
            return message.channel.send(`${client.emotes.error} - Só há uma música na fila.`);
        client.player.clearQueue(message);
        message.channel.send(`${client.emotes.success} - A fila acabou de ser  removida!`);
    });
}
exports.clearFila = clearFila;
;
//# sourceMappingURL=clear_fila.js.map
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (userMessage.channelId === process.env.NSFW_CHANNEL) {
                    ...
                    const response = (yield Axios.default.get(`${process.env.RULE34_LINK}&tags=${userMessage.content.split(' ')[1]}`, { params: (0, stringRemoveCommandFromParam_1.stringRemoveCommandFromParams)(userMessage) })).data;
                    if (response.length === 0) {
                        return (0, utils_1.searchError)(userMessage, language_1.SEARCH_RESULT_RETURNED_EMPTY);
                    }
                    ...
                    (0, utils_1.searchError)(userMessage, language_1.USE_THE_NSFW_CHAT_FOR_THIS);
                }
            }
            catch (err) {
                ...
                (0, utils_1.clearResponses)(message, 10000);
            }
        });
    }
}
exports.default = BotRule34SearchNSFW;
//# sourceMappingURL=rule34Search.command.js.map
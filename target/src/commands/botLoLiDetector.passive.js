            ...
            for (const chave of content) {
                if (chave === process.env.LOLI_DETECTOR) {
                    const embed = new Discord.MessageEmbed()
                        .setTitle("<@" + userMessage.author.id + "> " + language_1.LOLI_DETECTOR_MESSAGE)
                        .setColor('#fcfc00')
...
exports.default = BotLoliDetector;
//# sourceMappingURL=botLoLiDetector.passive.js.map